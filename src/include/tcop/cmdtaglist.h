...
PG_CMDTAG(CMDTAG_ASSIGN_RESOURCE_GROUP, "ASSIGN RESOURCE GROUP", false, false, false)
...
PG_CMDTAG(CMDTAG_UNASSIGN_RESOURCE_GROUP, "UNASSIGN RESOURCE GROUP", false, false, false)
